...
namespace Templates.Sketchy
{
    public partial class MasterPage : System.Web.UI.MasterPage, IMasterPage
    {
        ...
        {
            if (Request.UserAgent != null && (Request.UserAgent.Contains("MSIE 6.0") || Request.UserAgent.Contains("MSIE 7.0") || Request.UserAgent.Contains("MSIE 8.0")))
            {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (currentMode == SettingsDesign.eMainPageMode.Default)
            {
                ...
                liViewCss.Text = "<link rel=\"stylesheet\" href=\"Templates/Sketchy/css/default.css\" >";
            }
        ...
        protected void Page_PreRender(object sender, EventArgs e)
        {
            ...
            headStyle.Text = Bundle.Css()
                                   ...
                                   .Add("~/Templates/Sketchy/css/master.css")
