...
namespace Templates.Sketchy.UserControls.Default
{
    public partial class MainPageProduct : System.Web.UI.UserControl
    {
        ...
        {
            return string.Format("<a href=\"{0}\" class=\"mp-pv-lnk\"><img src=\"{1}\" alt=\"{2}\" title=\"{2}\" class=\"pv-photo p-photo scp-img\" /></a>",
