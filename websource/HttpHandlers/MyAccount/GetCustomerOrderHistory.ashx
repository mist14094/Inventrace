...
public class GetCustomerOrderHistory : IHttpHandler, IRequiresSessionState
{
    public void ProcessRequest(HttpContext context)
    {
        ...
        var orders = AdvantShop.Orders.OrderService.GetCustomerOrderHistory(AdvantShop.Customers.CustomerSession.CurrentCustomer.Id);
        ...
        var customerOrders = from item in orders
                             select new
                             {
                                 ...
                                 Sum = AdvantShop.Catalog.CatalogService.GetStringPrice(item.Sum, item.CurrencyValue, item.CurrencySymbol),
                                 item.OrderNumber,
                                 item.Payed
                             };
            ...
            new
                {
                    ...
                    TotalSum = AdvantShop.Catalog.CatalogService.GetStringPrice(totalPrice, 1, AdvantShop.Repository.Currencies.CurrencyService.CurrentCurrency.Symbol)
                }));
    }
