...
<body onload="position_this_window();window.print();">
    ...
    <div>
        ...
        <br />
        <center>
            <table cellspacing="1" cellpadding="4" width="100%" bgcolor="#aaaaaa" border="0" class="Spisok">
                <tbody>
                    ...
                    <asp:Repeater runat="server" ID="rCertificates" DataSource="<%# Order.OrderCertificates %>">
                        <ItemTemplate>
                            <tr bgcolor="white">
                                <td>
                                    <font class="sc">
                                ...
                                <td>
                                    <font class="sc"><b>
                                        <asp:Literal ID="Literal8" runat="server" Text='<%# Eval("CertificateCode") %>' />
                                    </b></font>
                                    <td>
                                        <font class="sc">
                                    ...
                                    <td>
                                        <font class="sc">
                                            <asp:Literal ID="Literal5" runat="server" Text='<%# CatalogService.GetStringPrice(SQLDataHelper.GetFloat(Eval("Sum")) * 1, Order.OrderCurrency.CurrencyValue, Order.OrderCurrency.CurrencyCode) %>' /></font>
                                    </td>
                                    <td>
                                        <font class="sc">
                                            <asp:Literal ID="Literal6" runat="server" Text='<%# Math.Round(0.0, 2).ToString("##,##0.00") + "%"%>' />
                                    ...
                                    <td style="text-align: right">
                                        <font class="sc">
                                            <asp:Literal ID="Literal7" runat="server" Text='<%# CatalogService.GetStringPrice(SQLDataHelper.GetFloat(Eval("Sum")) * 1 , Order.OrderCurrency.CurrencyValue, Order.OrderCurrency.CurrencyCode) %>' /></font>
                                    </td>
                            </tr>
                        </ItemTemplate>
                    </asp:Repeater>
                    ...
                    <% if (Order != null && Order.PaymentCost != 0)
                       { %>
                    <tr bgcolor="white">
                        <td>
                            <font class="sc">
                                <%= rptOrderItems.Items.Count + rCertificates.Items.Count + ((Order != null && Order.ShippingCost != 0) ? 2 : 1) %>
                            </font>
                        </td>
                        <td colspan="5">
                            <font class="sc"><b>
                        ...
                        <td style="text-align: right">
                            <font class="sc">
                                <%= Order != null ? CatalogService.GetStringPrice(Order.PaymentCost, Order.OrderCurrency.CurrencyValue, Order.OrderCurrency.CurrencyCode) : "" %></font>
                        </td>
                    </tr>
                    <% } %>
        ...
        <div>
            Всего наименований
            <%= Order != null ? (rptOrderItems.Items.Count + rCertificates.Items.Count + (Order.ShippingCost != 0 ? 1 : 0) + (Order.PaymentCost != 0 ? 1 : 0)).ToString() : "" %>, на сумму
