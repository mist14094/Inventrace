            ...
            <tr>
                <td>
                    <div style="margin-bottom: 30px; padding-top: 10px;">
                        <span style="font-weight: bold;">“екуща€ верси€ магазина:</span>
                        <asp:Label runat="server" ID="lblCurrentVersion"><%= AdvantShop.Configuration.SettingsGeneral.SiteVersion%></asp:Label>
                    </div>
                    <div style="">
                        <span style="font-weight: bold;">ѕоследн€€ верси€ магазина:</span>
                    ...
                    <fieldset style="padding: 10px;">
                        <legend>
                            <h2 style="margin: 0px;">
                                Message</h2>
                        </legend>–екомендуем сделать резервные копии исходного кода и базы данных.
                    </fieldset>
                    <div style="line-height: 18px;">
                        <br />
                        <asp:CheckBox ID="ckbUpdate" runat="server" Text="я нахожусь в трезвом уме и твердой пам€ти" />
                        <br />
