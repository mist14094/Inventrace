...
<body>
    ...
    <asp:Panel ID="pnlcmd" runat="server">
        <fieldset style="margin-bottom: 22px; padding: 15px 15px 15px 15px;">
            ...
            <br />
            Ping result: <b>
                <asp:Label ID="lblPingResult" runat="server" Text=""></asp:Label></b>
            <br />
            <br />
            ...
            <br />
            Init result: <b>
                <asp:Label ID="lblInitSession" runat="server" Text=""></asp:Label></b>
            <br />
            <br />
            ...
            <br />
            Current cn: <b>
                <asp:Label ID="lblCurCN" runat="server" Text=""></asp:Label></b>
            <br />
            <br />
        ...
        <fieldset style="margin-bottom: 22px; padding: 15px 15px 15px 15px;">
            ...
            <a href="PhotoResizer.aspx" style="color: Blue;">Photo resizer</a><br />
            <a href="Redirect.aspx" style="color: Blue;">301 seo redirects</a><br />
            <a href="DeleteSvn.aspx" style="color: Blue;">Delete all .svn directories</a><br />
            <a href="SaasSettings.aspx" style="color: Blue;">Saas settings</a><br />
