...
<head runat="server">
    ...
    <title>Зразок заповнення платіжного доручення
    </title>
    <style>
        <!--
        ...
        <table cellspacing="0" cols="36" border="0" width="768px">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td style="border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000" colspan="11" rowspan="2" align="left">
                        <br>
                    </td>
                    <td align="left">
                        <br>
                ...
                <tr>
                    <td style="border-bottom: 1px solid #000000; border-left: 1px solid #000000" height="11" align="left">
                        <br>
                    </td>
                    <td style="border-bottom: 1px solid #000000;" colspan="34">
                        <br>
                    </td>
                ...
                <tr>
                    <td height="45" align="left" colspan="37">
                        <br>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    <td height="15" align="left" colspan="36">
                        <br>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    <td height="9" align="left" colspan="36">
                        <br>
                    </td>
                </tr>
                <tr>
                ...
                <% } %>
                <tr>
                    <td style="border-top: 1px solid #000000" height="9" align="left" colspan="36">
                        <br>
                    </td>
                </tr>
                <tr id="trDiscount" runat="server">
                    <td height="16" align="left" colspan="28">
                        <br>
                    </td>
                ...
                <tr id="trTaxSum" runat="server">
                    <td height="16" align="left" colspan="25">
                        <br>
                    </td>
                ...
                <tr>
                    <td style="border-bottom: 1px solid #000000" height="9" colspan="36">
                        <br>
                    </td>
                </tr>
                <tr>
                    <td height="15" colspan="36">
                        <br>
                    </td>
                </tr>
                <tr>
                    <td height="16" align="left" colspan="18">
                        <br>
                    </td>
