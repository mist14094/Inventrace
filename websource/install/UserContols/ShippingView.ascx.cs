...
public partial class install_UserContols_ShippingView : AdvantShop.Controls.InstallerStep
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        txteDostPass.Visible = !(Demo.IsDemoEnabled || Trial.IsTrialEnabled);
        leDostPassword.Visible = Demo.IsDemoEnabled || Trial.IsTrialEnabled;
    ...
    public new void LoadData()
    {
        ...
        if (sm != null && sm.Type == ShippingType.FixedRate)
        {
            ...
            txtCourier.Text = sm.Params[FixeRateShippingTemplate.ShippingPrice];
        }
        ...
        if (sm != null && sm.Type == ShippingType.eDost)
        {
            ...
            txteDostNumer.Text = sm.Params[EdostTemplate.ShopId];
            txteDostPass.Text = sm.Params[EdostTemplate.Password];
