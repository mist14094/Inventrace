...
public partial class install_UserContols_FinanceView : AdvantShop.Controls.InstallerStep
{
    ...
    public new bool Validate()
    {
        ...
        validList.Add(new ValidElement() { Control = txtPlan, ErrContent = ErrContent, ValidType = ValidType.Money, Message = Resources.Resource.Install_UserContols_FinanceView_Err_Plan });
        validList.Add(new ValidElement() { Control = txtPlaPribl, ErrContent = ErrContent, ValidType = ValidType.Money, Message = Resources.Resource.Install_UserContols_FinanceView_Err_PlaPribl });
        validList.Add(new ValidElement() { Control = txtMinOrderPrice, ErrContent = ErrContent, ValidType = ValidType.Money, Message = Resources.Resource.Install_UserContols_FinanceView_Err_MinOrderPrice });
        validList.Add(new ValidElement() { Control = txtMaxPriceGift, ErrContent = ErrContent, ValidType = ValidType.Money, Message = Resources.Resource.Install_UserContols_FinanceView_Err_MaxPriceGift });
        validList.Add(new ValidElement() { Control = txtMinPriceGift, ErrContent = ErrContent, ValidType = ValidType.Money, Message = Resources.Resource.Install_UserContols_FinanceView_Err_MinPriceGift });
