...
<asp:Content ID="Content1" ContentPlaceHolderID="cphMain" runat="Server">
  ...
  <span class="param-name param-name-txt">
                ...
                <div id="pnlPrice" runat="server">
                    <div class="price-c">
                        <%= CatalogService.RenderPrice(CurrentProduct.Offers[0].Price, CurrentProduct.CalculableDiscount, true, CustomerSession.CurrentCustomer.CustomerGroup, CustomOptionsService.SerializeToXml(productCustomOptions.CustomOptions, productCustomOptions.SelectedOptions)) %>
                    </div>
                    <div class="btns-d">
