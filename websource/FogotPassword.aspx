        ...
        <div class="content-owner">
            ...
            <asp:MultiView ID="MultiView1" runat="server" ActiveViewIndex="0">
                <asp:View ID="ViewDataCollecting" runat="server">
                    <div class="form-c">
                        <div class="title">
                            <%=Resources.Resource.Client_FogotPassword_EnterEmail%></div>
                        <ul class="form">
                            <li>
                        ...
                        <div>
                            <adv:Button ID="btnSendPasswordByEmail" runat="server" Type="Action" Size="Middle"
                                Text="<%$ Resources:Resource, Client_FogotPassword_Recover %>" OnClick="btnSendPasswordByEmail_Click">
                            </adv:Button>
                            <br />
                            <br />
                        </div>
                ...
                <asp:View ID="ViewRecovery" runat="server">
                    <div class="form-c">
                        <div class="title">
                            <%=Resources.Resource.Client_FogotPassword_ChangePassword%></div>
                        <ul class="form">
                            <li>
