...
//--------------------------------------------------
public partial class UserControls_CustomOptions : UserControl
{
    ...
    public UserControls_CustomOptions()
    {
        IsValid = true;
        ShowValidation = true;
    }
    ...
    {
        return CatalogService.CalculateProductPrice(price, Product.Discount, CustomerSession.CurrentCustomer.CustomerGroup, null);
    }
}