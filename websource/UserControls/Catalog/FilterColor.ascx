<%@ Control Language="C#" AutoEventWireup="true" CodeFile="FilterColor.ascx.cs" Inherits="UserControls_FilterColor" %>
<%@ Import Namespace="AdvantShop" %>
<%@ Import Namespace="AdvantShop.Configuration" %>
<%@ Import Namespace="AdvantShop.Helpers" %>
<!--noindex-->
<article class="block-uc-inside" data-plugin="expander">
    <h4 class="title" data-expander-control="#color-filter">
