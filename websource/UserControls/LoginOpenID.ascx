<%@ Control Language="C#" AutoEventWireup="true" CodeFile="LoginOpenID.ascx.cs" Inherits="UserControls_LoginOpenID" %>
<div class="auth-social" runat="server" id="divSocial">
    <div class="title">
...
<script type="text/javascript">
    $(function () {
        $.advModal({ title: "<%= Resources.Resource.Client_Login_EnterEmail %>", htmlContent: $("#modalMail"), control: "#lnkbtnMail", afterOpen: function () { $("#txtOauthUserId").focus(); } });
    });
</script>
