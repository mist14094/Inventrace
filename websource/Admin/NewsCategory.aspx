...
<asp:Content ID="Content2" ContentPlaceHolderID="cphMain" runat="Server">
    ...
    <div class="content-own">
        ...
        <div style="width: 100%">
            <div>
                <div>
                    <adv:AdvButton ID="btnAddCategory" runat="server" Width="170" Text="<%$ Resources:Resource, Admin_NewsCategory_Add %>"
                        ...
                        CssCenterDiv="adv_OrangeButton_CenterDiv" ValidationGroup="0" OnClick="btnAddCategory_Click" />
                </div>
                            ...
                            <adv:AdvGridView ID="grid" runat="server" AllowSorting="true" AutoGenerateColumns="False"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField AccessibleHeaderText="UrlPath" HeaderStyle-HorizontalAlign="Left">
                                        <HeaderTemplate>
                                            <asp:LinkButton ID="lbUrlPath" runat="server" CommandName="Sort" CommandArgument="UrlPath">
                                                UrlPath
                                                <asp:Image ID="arrowUrlPath" CssClass="arrow" runat="server" ImageUrl="images/arrowdownh.gif" /></asp:LinkButton>
                                        </HeaderTemplate>
                                        <EditItemTemplate>
                                            <asp:TextBox ID="txtUrlPath" runat="server" Text='<%# Eval("UrlPath") %>' Width="99%"></asp:TextBox>
                                        </EditItemTemplate>
                                        <ItemTemplate>
                                            <asp:Label ID="lUrlPath" runat="server" Text='<%# Bind("UrlPath") %>'></asp:Label>
                                        </ItemTemplate>
                                        <FooterTemplate>
                                            <asp:TextBox ID="txtNewUrlPath" runat="server" CssClass="add" Text='' Width="99%"></asp:TextBox>
                                        </FooterTemplate>
                                    </asp:TemplateField>
                                    ...
                                    <asp:TemplateField ItemStyle-Width="30px" HeaderStyle-Width="30px" ItemStyle-HorizontalAlign="Center"
                                        ...
                                        <FooterTemplate>
                                            <asp:ImageButton ID="ibAddCategory" runat="server" ImageUrl="images/addbtn.gif" CommandName="AddCategory"
                                                ToolTip="<%$ Resources:Resource, Admin_NewsCategory_Add  %>" />
                                        </FooterTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField ItemStyle-Width="30px" HeaderStyle-Width="30px" ItemStyle-HorizontalAlign="Left"
                                        ...
                                        <EditItemTemplate>
                                            <asp:ImageButton ID="buttonDelete" runat="server" ImageUrl="images/deletebtn.png"
                                                CssClass="deletebtn showtooltip" CommandName="DeleteCategory" CommandArgument='<%# Eval("ID")%>'
                                            ...
                                            <ajaxToolkit:ConfirmButtonExtender ID="ConfirmButtonExtender2" runat="server" TargetControlID="buttonDelete"
                                                ConfirmText="<%$ Resources:Resource, Admin_NewsCategory_Confirmation %>">
