<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPageAdmin.master" AutoEventWireup="true"
    CodeFile="Coupons.aspx.cs" Inherits="Admin.Coupons" %>
                ...
                <tbody>
                    <tr>
                        ...
                        <td>
                            ...
                            <asp:Label ID="lblSubHead" CssClass="AdminSubHead" runat="server" Text="<%$ Resources:Resource, Admin_Coupons_SubHeader %>"></asp:Label>
                            <div style="display: block; margin-top: 10px">
                                <asp:Localize ID="Localize9" runat="server" Text="<% $Resources:Resource, Admin_Discount_Coupons_CustomerGroupMessage %>"></asp:Localize>
                            </div>
                        </td>
                    </tr>
                </tbody>
                ...
                <div>
                    <div>
                        <adv:AdvButton ID="btnAdd" runat="server" Width="170" Text="<%$ Resources:Resource, Admin_HeadCmdInsert %>"
                            ...
                            OnClientClick="javascript:open_window('m_Coupon.aspx',750,600);return false;" />
                    </div>
                            ...
                            <table class="filter" cellpadding="0" cellspacing="0">
                                ...
                                <tr>
                                    ...
                                    <td style="width: 260px;">
                                        <div style="width: 260px; height: 0px; font-size: 0px;">
                                        </div>
                                    </td>
                                ...
                                <adv:AdvGridView ID="grid" runat="server" AllowSorting="true" AutoGenerateColumns="False" CellPadding="0"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField AccessibleHeaderText="Code" HeaderStyle-HorizontalAlign="Left">
                                            ...
                                            <EditItemTemplate>
                                                <asp:TextBox ID="txtCode" runat="server" Text='<%# Eval("Code") %>' Width="99%" MaxLength="10"></asp:TextBox>
                                            </EditItemTemplate>
                                            <ItemTemplate>
                                        ...
                                        <asp:TemplateField AccessibleHeaderText="Value" HeaderStyle-HorizontalAlign="Left" HeaderStyle-Width="100">
                                            ...
                                            <EditItemTemplate>
                                                <asp:TextBox ID="txtValue" runat="server" Text='<%# SQLDataHelper.GetDecimal(Eval("Value")).ToString("F2") %>'
                                        ...
                                        <asp:TemplateField AccessibleHeaderText="Enabled" HeaderStyle-Width="40" ItemStyle-HorizontalAlign="Center"
                                            ...
                                            <ItemTemplate>
                                                <asp:CheckBox ID="chkEnabled" runat="server" Checked='<%# Eval("Enabled") %>' Enabled="false" />
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        ...
                                        <asp:TemplateField ItemStyle-Width="85px" HeaderStyle-Width="85px" ItemStyle-HorizontalAlign="Center"
                                            ...
                                            <EditItemTemplate>
                                                ...
                                                <ajaxToolkit:ConfirmButtonExtender ID="ConfirmButtonExtender2" runat="server" TargetControlID="buttonDelete"
                                                    ConfirmText='<%# String.Format(Resources.Resource.Admin_Coupons_Confirmation, Eval("Code")) %>'>
