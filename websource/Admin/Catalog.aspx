...
<asp:Content ID="RootContent" ContentPlaceHolderID="cphMain" runat="Server">
    ...
    <ul class="two-column">
        ...
        <li class="two-column-item">
            ...
            <asp:LinkButton ID="hlDeleteCategory" CssClass="lnk-remove" runat="server" Text="<%$ Resources:Resource, Admin_MasterPageAdminCatalog_FPanel_DeleteCategory %>"
                OnClick="hlDeleteCategory_Click"></asp:LinkButton>
            <ajaxToolkit:ConfirmButtonExtender ID="ConfirmButtonExtenderCategory" runat="server" TargetControlID="hlDeleteCategory">
                        ...
                        <asp:Panel runat="server" ID="filterPanel" DefaultButton="btnFilter">
                            <table class="filter" cellpadding="0" cellspacing="0">
                                ...
                                <tr>
                                    ...
                                    <td style="width: 120px; text-align: center; white-space: nowrap; display: none" rowspan="2">
                                        <asp:DropDownList ID="ddlIsFirstPageProducts" TabIndex="18" CssClass="dropdownselect" runat="server">
                                            <asp:ListItem Selected="True" Text="<%$ Resources:Resource, Admin_Catalog_Any %>" />
                                            <asp:ListItem Text="<%$ Resources:Resource, Admin_Catalog_Yes %>" />
                                            <asp:ListItem Text="<%$ Resources:Resource, Admin_Catalog_No %>" />
                                        </asp:DropDownList>
                                    ...
                                    <td style="width: 95px; padding-right: 10px; text-align: right; white-space: nowrap;">
                                        <span class="textfromto">
                                            <%=Resources.Resource.Admin_Catalog_From%>:</span><asp:TextBox CssClass="filtertxtbox" ID="txtSortOrderFrom"
                                ...
                                <tr>
                                    <td style="width: 95px; padding-right: 0px; text-align: right; white-space: nowrap">
                                        <span class="textfromto">
                                            <%=Resources.Resource.Admin_Catalog_To%>:</span><asp:TextBox CssClass="filtertxtbox" ID="txtPriceTo"
                                                runat="server" Font-Size="10px" Width="50" TabIndex="14" />
                                    </td>
                                    <td style="width: 100px; padding-right: 0px; text-align: right; white-space: nowrap">
                                        <span class="textfromto">
                                            <%=Resources.Resource.Admin_Catalog_To%>:</span><asp:TextBox CssClass="filtertxtbox" ID="txtQtyTo" runat="server"
                                    ...
                                    <td style="width: 95px; padding-right: 10px; text-align: right; white-space: nowrap">
                                        <span class="textfromto">
                                            <%=Resources.Resource.Admin_Catalog_To%>:</span><asp:TextBox CssClass="filtertxtbox" ID="txtSortOrderTo"
                                ...
                                <adv:AdvGridView ID="grid" runat="server" AllowSorting="true" AutoGenerateColumns="False" CellPadding="0"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField AccessibleHeaderText="ArtNo" ItemStyle-CssClass="colid" ItemStyle-HorizontalAlign="Left"
                                            ...
                                            <HeaderTemplate>
                                                <asp:LinkButton ID="lbOrderId" runat="server" CommandName="Sort" CommandArgument="Product.ArtNo">
                                            ...
                                            <EditItemTemplate>
                                                <asp:TextBox ID="txtStockNumber" runat="server" Text='<%# Eval("ArtNo") %>' Width="99%"></asp:TextBox>
                                            </EditItemTemplate>
                                            <ItemTemplate>
                                        ...
                                        <asp:TemplateField AccessibleHeaderText="Price" ItemStyle-HorizontalAlign="Center">
                                            <HeaderTemplate>
                                        ...
                                        <asp:TemplateField AccessibleHeaderText="Qty" ItemStyle-HorizontalAlign="Center">
                                            <HeaderTemplate>
                                        ...
                                        <asp:TemplateField AccessibleHeaderText="Buttons" ItemStyle-HorizontalAlign="Center">
                                            ...
                                            <EditItemTemplate>
                                                ...
                                                <asp:ImageButton ID="buttonDeleteLink" runat="server" ToolTip="<%$ Resources:Resource, Admin_MasterPageAdminCatalog_DeleteFromCategory%>"
                                                    ImageUrl="images/excludebtn.png" CssClass="deletebtn showtooltip" CommandName="Deletelink" CommandArgument='<%# Eval("ID") %>' />
                                                ...
                                                <%}%>
                                                <asp:LinkButton ID="buttonDelete" runat="server" CssClass="deletebtn showtooltip" ToolTip='<%$ Resources:Resource, Admin_MasterPageAdminCatalog_Delete %>'
                                                    CommandArgument='<%# Eval("ID") %>'>
                                                    <asp:Image ID="Image1" ImageUrl="images/deletebtn.png" runat="server" />
                                                </asp:LinkButton>
                                                <ajaxToolkit:ConfirmButtonExtender ID="ConfirmButtonExtenderbuttonDelete" runat="server" TargetControlID="buttonDelete">
                                                </ajaxToolkit:ConfirmButtonExtender>
                                                ...
                                                <input id="btnCancel" name="btnCancel" class="cancelbtn showtooltip" type="image" src="images/cancelbtn.png"
                                                    onclick="row_canceledit($(this).parent().parent()[0]); return false;" style="display: none" title='<%=
                                        ...
                                        <td style="width: 157px; text-align: right; padding-right: 12px">
                                            <asp:Panel ID="goToPage" runat="server" DefaultButton="btnGo">
                                                <span style="color: #494949">
                                                    <%=Resources.Resource.Admin_Catalog_PageNum%>&nbsp; <span class="input-wrap">
