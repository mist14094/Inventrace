...
<asp:Content ID="Content2" ContentPlaceHolderID="cphMain" runat="Server">
    ...
    <div style="padding-left: 10px; padding-right: 10px">
        ...
        <div style="width: 100%">
            <div>
                <div>
                    <adv:AdvButton ID="btnAddSize" runat="server" Width="170" Text="<%$ Resources:Resource, Admin_SizesDictionary_AddSize %>"
                        ...
                        ValidationGroup="0" OnClick="btnAddSize_Click" />
                </div>
                            ...
                            <adv:AdvGridView ID="grid" runat="server" AllowSorting="true" AutoGenerateColumns="False" CellPadding="0"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField AccessibleHeaderText="SizeName" HeaderStyle-HorizontalAlign="Left">
                                        ...
                                        <EditItemTemplate>
                                            <asp:TextBox ID="txtName" runat="server" Text='<%# Eval("SizeName") %>' Width="99%"></asp:TextBox>
                                        </EditItemTemplate>
                                        <ItemTemplate>
                                    ...
                                    <asp:TemplateField ItemStyle-Width="25px" HeaderStyle-Width="25px" ItemStyle-HorizontalAlign="Left" FooterStyle-HorizontalAlign="Left">
                                        <EditItemTemplate>
                                            <asp:ImageButton ID="buttonDelete" runat="server" ImageUrl="images/deletebtn.png" CssClass="deletebtn showtooltip"
                                                CommandName="DeleteSize" CommandArgument='<%# Eval("ID")%>' ToolTip='<%$ Resources:Resource, Admin_MasterPageAdminCatalog_Delete %>' />
                                            <ajaxToolkit:ConfirmButtonExtender ID="ConfirmButtonExtender2" runat="server" TargetControlID="buttonDelete"
                                                ConfirmText="<%$ Resources:Resource, Admin_SizesDictionary_Confirm %>">
