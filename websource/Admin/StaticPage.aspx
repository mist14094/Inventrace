                    ...
                    <table width="98%">
                        ...
                        <tr>
                            ...
                            <td style="text-align: right">
                                <adv:OrangeRoundedButton ID="btnSave" runat="server" OnClick="btnSave_Click" onmousedown="window.onbeforeunload=null;" />
                            </td>
                        </tr>
                        <tr>
                            <td colspan="3">
                                ...
                                <div class="tab-content">
                                    <table border="0" cellpadding="2" cellspacing="0" width="95%">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <CKEditor:CKEditorControl ID="fckPageText" BasePath="~/ckeditor/" runat="server" Height="500px" Width="100%" />
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
