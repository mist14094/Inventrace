    ...
    <div style="padding-left: 10px; padding-right: 10px">
        <table cellpadding="0" cellspacing="0" width="100%">
            <tbody>
                <tr>
                    <td style="width: 72px;">
                        <img src="~/admin/images/orders_ico.gif" alt="" />
                    </td>
                    <td>
        ...
        <div style="width: 100%">
            <div>
                <div>
                    <adv:AdvButton ID="btnAdd" runat="server" Width="170" Text="<%$ Resources:Resource, Admin_HeadCmdInsertVoitingAnswer %>"
                        ...
                        CssCenterDiv="adv_OrangeButton_CenterDiv" OnClick="btnAdd_Click" />
                </div>
                            ...
                            <adv:AdvGridView ID="grid" runat="server" AllowSorting="true" AutoGenerateColumns="False"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField AccessibleHeaderText="CountVoice" HeaderStyle-HorizontalAlign="Left"
                                        ...
                                        <EditItemTemplate>
                                            <asp:TextBox ID="txtCountVoice" runat="server" Text='<%# Eval("CountVoice") %>' Width="99%"></asp:TextBox>
                                        </EditItemTemplate>
                                        <ItemTemplate>
                                    ...
                                    <asp:TemplateField ItemStyle-Width="30px" HeaderStyle-Width="30px" ItemStyle-HorizontalAlign="Left" FooterStyle-HorizontalAlign="Left">
                                        <EditItemTemplate>
                                            <asp:ImageButton ID="buttonDelete" runat="server" ImageUrl="images/deletebtn.png"
                                                CssClass="deletebtn showtooltip" CommandName="DeleteAnswer" CommandArgument='<%# Eval("ID")%>'
                                            ...
                                            <ajaxToolkit:ConfirmButtonExtender ID="ConfirmButtonExtender2" runat="server" TargetControlID="buttonDelete"
                                                ConfirmText="<%$ Resources:Resource, Admin_Answers_Confirmation %>">
