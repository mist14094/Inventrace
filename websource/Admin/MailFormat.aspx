...
<asp:Content ID="Content2" ContentPlaceHolderID="cphMain" runat="Server">
    ...
    <div class="content-own">
        ...
        <div>
            <div>
                <div>
                    <adv:AdvButton ID="btnAddMailFormat" runat="server" Width="170" Text="<%$ Resources:Resource, Admin_MailFormat_Add %>"
                        ...
                        CssCenterDiv="adv_OrangeButton_CenterDiv" ValidationGroup="0" OnClick="btnAddMailFormat_Click" />
                </div>
                        ...
                        <table class="filter" cellpadding="0" cellspacing="0">
                            ...
                            <tr>
                                ...
                                <td style="width: 200px; text-align: center;">
                                    ...
                                    <asp:DropDownList ID="ddlFormatType" CssClass="dropdownselect" runat="server" DataSourceID="sdsType"
                            ...
                            <adv:AdvGridView ID="grid" runat="server" AllowSorting="true" AutoGenerateColumns="False"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField AccessibleHeaderText="FormatName" HeaderStyle-HorizontalAlign="Left">
                                        ...
                                        <EditItemTemplate>
                                            <asp:TextBox ID="txtName" runat="server" Text='<%# Eval("FormatName") %>' Width="99%"></asp:TextBox>
                                        </EditItemTemplate>
                                        <ItemTemplate>
                                    ...
                                    <asp:TemplateField AccessibleHeaderText="Enable" ItemStyle-Width="150" ItemStyle-HorizontalAlign="Center"
                                        FooterStyle-HorizontalAlign="Center">
                                        <HeaderTemplate>
                                    ...
                                    <asp:TemplateField ItemStyle-Width="80px" HeaderStyle-Width="80px" ItemStyle-HorizontalAlign="center"
                                        ...
                                        <EditItemTemplate>
                                            ...
                                            <asp:ImageButton ID="buttonDelete" runat="server" ImageUrl="images/deletebtn.png"
                                                CssClass="deletebtn showtooltip" CommandName="DeleteMailFormat" CommandArgument='<%# Eval("ID")%>'
                                            ...
                                            <ajaxToolkit:ConfirmButtonExtender ID="ConfirmButtonExtender2" runat="server" TargetControlID="buttonDelete"
                                                ConfirmText="<%$ Resources:Resource, Admin_MailFormat_Confirmation %>">
