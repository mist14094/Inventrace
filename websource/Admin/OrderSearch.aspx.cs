...
namespace Admin
{
    public partial class OrderSearch : AdvantShopAdminPage
    {
        ...
        protected void FillStatusFilter()
        {
            ...
            foreach (var str in OrderService.GetOrderStatuses().Select(s => s.StatusName))
            {
                ddlStatusName.Items.Add(new ListItem(str, str.ToLower()));
            }
        }
        ...
        //{
        //    // OrderService.DeleteOrder((int)e.Values["OrderID"]);
        //}
            ...
            if (_selectionFilter != null)
            {
                ...
                foreach (string id in ids)
                {
                    ...
                    if (oldStatus != int.Parse(ddlStatus.SelectedValue))
                    {
                        ...
                        AdvantShop.Modules.ModulesRenderer.OrderChangeStatus(int.Parse(id));
                    }
                }
            }
        }
