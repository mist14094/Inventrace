                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td style="width: 210px;" class="tdExpiration">
                                                <asp:TextBox ID="txtExpirationDate" runat="server" Width="200px" />
                                            </td>
                                            <td class="tdExpiration">
                                                <asp:Image ID="popupDate" runat="server" ImageUrl="~/Admin/images/Calendar_scheduleHS.png" />
                                                <ajaxToolkit:CalendarExtender TargetControlID="txtExpirationDate" PopupButtonID="popupDate" Format="dd.MM.yyyy"
                                                    CssClass="popupCalendar" BehaviorID="calendar" ID="CalendarExtender2" runat="server"
                                                    PopupPosition="Right">
