...
namespace Admin
{
    public partial class MailFormatPage : AdvantShopAdminPage
    {
        ...
        protected void lbDeleteSelected_Click(object sender, EventArgs e)
        {
            if ((_selectionFilter != null) && (_selectionFilter.Values != null))
            {
                ...
                if (!_inverseSelection)
                {
                    ...
                    {
                        MailFormatService.DeleteMailFormat(SQLDataHelper.GetInt(id));
                    }
                }
                else
                {
                    ...
                    {
                        MailFormatService.DeleteMailFormat(id);
                    }
                }
            }
        }
        ...
        protected void grid_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            {
                MailFormatService.DeleteMailFormat(SQLDataHelper.GetInt(e.CommandArgument));
            }
        }
        ...
        protected void Page_PreRender(object sender, EventArgs e)
        {
            ...
            {
                var temp = MailFormatService.GetMailFormat(SQLDataHelper.GetInt(grid.UpdatedRow["ID"]));
