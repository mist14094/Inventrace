<%@ Control Language="C#" AutoEventWireup="true" CodeFile="IndicatorsStatistic.ascx.cs"
    Inherits="Admin_UserControls_IndicatorsStatistic" %>
<article>
    <h2>
    ...
    <div>
        <ul class="statistic-data">
            <li class="statistic-data-row">
                ...
                <div class="statistic-data-info">
                    <p class="statistic-data-coefficient">
                        <asp:Label ID="lblSaleToday" runat="server" /></p>
            ...
            <li class="statistic-data-row">
                ...
                <div class="statistic-data-info">
                    <p class="statistic-data-coefficient">
                        <asp:Label ID="lblSaleYesterday" runat="server" /></p>
                    <p class="statistic-data-desrc">
            ...
            <li class="statistic-data-row">
                ...
                <div class="statistic-data-info">
                    <p class="statistic-data-coefficient">
                        <asp:Label ID="lblSaleWeek" runat="server" /></p>
                    <p class="statistic-data-desrc">
            ...
            <li class="statistic-data-row">
                ...
                <div class="statistic-data-info">
                    <p class="statistic-data-coefficient">
                        <asp:Label ID="lblSaleMounth" runat="server" /></p>
                    <p class="statistic-data-desrc">
            ...
            <li class="statistic-data-row">
                ...
                <div class="statistic-data-info">
                    <p class="statistic-data-coefficient">
                        <asp:Label ID="lblSale" runat="server" /></p>
                    <p class="statistic-data-desrc">
