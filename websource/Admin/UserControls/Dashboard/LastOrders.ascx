<%@ Control Language="C#" AutoEventWireup="true" CodeFile="LastOrders.ascx.cs" Inherits="Admin_UserControls_LastOrders" %>
            ...
            <tr data-redirect='<%# "vieworder.aspx?OrderID=" + Eval("OrderID") %>'>
                ...
                <td class="table-ui-align-center">
                    ...
                    <asp:LinkButton runat="server" ID="buttonDelete" runat="server" CommandName="DeleteOrder" CommandArgument='<%# Eval("OrderID") %>'
                        CssClass="showtooltip" ToolTip='<%$ Resources:Resource, Admin_OrderSearch_Delete%>'>
                    ...
                    <ajaxToolkit:ConfirmButtonExtender ID="ConfirmButtonExtender2" runat="server" TargetControlID="buttonDelete"
                        ConfirmText='<%# string.Format(Resources.Resource.Admin_OrderSearch_DeleteOrder, Eval("OrderID")) %>'>
