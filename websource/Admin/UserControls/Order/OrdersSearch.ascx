...
<div class="panel-toggle">
    ...
    <asp:SqlDataSource ID="sdsStatuses" runat="server" SelectCommand="SELECT OrderStatusID, StatusName, Color, (Select Count(OrderID) From [Order].[Order] Where [OrderStatusID] = OrderStatus.[OrderStatusID]) as OrdersCount FROM [Order].OrderStatus"
