...
<div class="justify">
    ...
    <a href="Product.aspx?categoryid=<%=Request["categoryid"] %>" class="showtooltip  products-header-controls" title="<%= Resources.Resource.Admin_MasterPageAdminCatalog_AddNewCategory %>">
        <img src="images/gplus.gif" onmouseover="this.src='images/bplus.gif'" onmouseout="this.src='images/gplus.gif';"  title="<%= Resources.Resource.Admin_MasterPageAdminCatalog_AddNewCategory %>" /></a>   
