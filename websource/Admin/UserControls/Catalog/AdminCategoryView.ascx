<%@ Control Language="C#" AutoEventWireup="true" CodeFile="AdminCategoryView.ascx.cs"
    Inherits="Admin_Catalog_AdminCategoryView" %>
        ...
        <li class="list-categories-item">
            <div class="deleteCategoryButton">
                <a href="<%# "javascript:open_window('m_Category.aspx?CategoryID=" + Eval("CategoryID") + "&mode=edit', 750, 640)" %>"
                 ...
                 <asp:LinkButton ID="ibtnDeleteCategory" runat="server" CommandArgument='<%#Eval("CategoryID") %>' CommandName="DeleteCategory">
                ...
                <ajaxToolkit:ConfirmButtonExtender ID="ConfirmButtonExtenderCategory" runat="server"
                    ConfirmText="<%$ Resources:Resource ,Admin_Product_ConfirmDeletingCategory %>"
                    TargetControlID="ibtnDeleteCategory">
