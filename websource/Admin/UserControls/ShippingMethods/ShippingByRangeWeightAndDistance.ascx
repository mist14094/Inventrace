<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ShippingByRangeWeightAndDistance.ascx.cs" Inherits="Admin_UserControls_ShippingMethods_ShippingByRangeWeightAndDistance" %>
