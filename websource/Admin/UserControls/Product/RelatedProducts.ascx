<%@ Control Language="C#" AutoEventWireup="true" CodeFile="RelatedProducts.ascx.cs"
    Inherits="Admin.UserControls.Product.RelatedProducts" %>
                    ...
                    <table style="width: 100%; margin-top: 10px;">
                        <tr>
                            ...
                            <td style="vertical-align: middle;">
                                ...
                                <asp:TextBox ID="txtProductArtNo" runat="server"></asp:TextBox>
                                <asp:Button ID="lbAddRelatedProductByArtNo" runat="server" OnClick="lbAddRelatedProductByArtNo_Click"
