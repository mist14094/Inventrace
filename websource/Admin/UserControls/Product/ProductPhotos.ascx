<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ProductPhotos.ascx.cs"
    Inherits="Admin.UserControls.Product.ProductPhotos" %>
...
<table class="table-p">
    ...
    <tr>
        <td colspan="2" style="text-align: right">
            <input type="button" style="height: 21px; width: 83px" name="btnUploadPhoto" value="<%=Resources.Resource.Admin_m_Product_Upload%>" onclick="ajaxFileUpload()" />
        </td>
    </tr>
