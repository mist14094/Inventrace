    ...
    <tr>
        ...
        <td class="columnDescr">
            <asp:Image ID="Image2" runat="server" Width="18" Height="18" ImageUrl="~/Admin/images/messagebox_info.png"
                ToolTip="<%$ Resources:Resource, Admin_PaymentMethod_YandexKassa_PasswordDescription %>" /><asp:Label runat="server"
                    ID="msgPassword" Visible="false" ForeColor="Red"></asp:Label>
        </td>
    </tr>
    <tr>
        <td class="columnName">
            <asp:Localize runat="server" Text="<%$ Resources:Resource, Admin_PaymentMethod_Yandex_Certificate %>"></asp:Localize><%--<span class="required">&nbsp;*</span>--%>
        </td>
        <td class="columnVal">
            <asp:FileUpload runat="server" ID="fuCertificate" Width="250"/>
            <asp:TextBox runat="server" ID="txtCertificate" Visible="False"/>
        </td>
        <td class="columnDescr">
            <asp:Image runat="server" Width="18" Height="18" ImageUrl="~/Admin/images/messagebox_info.png" ToolTip="<%$ Resources:Resource, Admin_PaymentMethod_Yandex_Certificate_Description %>" /><asp:Label runat="server" ID="msgCertificate" Visible="false" ForeColor="Red"></asp:Label>
        </td>
    </tr>
</table>
