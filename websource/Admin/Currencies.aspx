        ...
        <table cellpadding="0" cellspacing="0" width="100%">
            <tbody>
                <tr>
                    ...
                    <td>
                        <asp:Label ID="lblHead" CssClass="AdminHead" runat="server" Text="<%$ Resources:Resource, Admin_Currencies_Header %>"></asp:Label><br />
                        <asp:Label ID="lblSubHead" CssClass="AdminSubHead" runat="server" Text="<%$ Resources:Resource, Admin_Currencies_SubHeader %>"></asp:Label><br />
                        <asp:CheckBox ID="chkAutoUpdateEnabled" runat="server" Text="<%$ Resources:Resource, Admin_Currencies_AutoUpdate %>"
                                    OnCheckedChanged="chkAutoUpdateEnabled_CheckedChanged" AutoPostBack="True" />
                    </td>
                    <td>
                        <div style="float: right; padding-right: 20px">
                            ...
                            <div>
                                <adv:AdvButton ID="btnUpdateCurrencies" runat="server" Width="200" Text="<%$ Resources:Resource, Admin_Currencies_GetCurriencies%>"
                                    ...
                                    CssCenterDiv="adv_OrangeButton_CenterDiv2" ValidationGroup="0" OnClick="btnUpdateCurrencies_Click" />
                                <adv:AdvButton ID="btnAddCurrency" runat="server" Width="170" Text="<%$ Resources:Resource, Admin_Currencies_Add %>"
                                    CssMain="adv_OrangeButton_Main" CssInput="adv_OrangeButton_Input" CssInputMozz="adv_OrangeButton_Input-mozz"
                                    CssLeftDiv="adv_OrangeButton_LeftDiv" CssRightDiv="adv_OrangeButton_RightDiv"
                                    CssCenterDiv="adv_OrangeButton_CenterDiv" ValidationGroup="0" OnClick="btnAddCurrency_Click" />
                            </div>
                        </div>
                    </td>
                </tr>
                        ...
                        <adv:AdvGridView ID="grid" runat="server" AllowSorting="true" AutoGenerateColumns="False"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField AccessibleHeaderText="Name" HeaderStyle-HorizontalAlign="Left">
                                    ...
                                    <EditItemTemplate>
                                        <asp:TextBox ID="txtName" runat="server" Text='<%# Eval("Name") %>' Width="99%" MaxLength="30"></asp:TextBox>
                                    </EditItemTemplate>
                                    <ItemTemplate>
                                ...
                                <asp:TemplateField ItemStyle-HorizontalAlign="center" FooterStyle-HorizontalAlign="Center"
                                    ...
                                    <EditItemTemplate>
                                        ...
                                        <asp:ImageButton ID="buttonDelete" runat="server" ImageUrl="images/deletebtn.png"
                                            CssClass="deletebtn showtooltip" CommandName="DeleteCurrency" CommandArgument='<%# Eval("ID")%>'
                                        ...
                                        <ajaxToolkit:ConfirmButtonExtender ID="ConfirmButtonExtender2" runat="server" TargetControlID="buttonDelete"
                                            ConfirmText="<%$ Resources:Resource, Admin_Currencies_Confirmation %>">
