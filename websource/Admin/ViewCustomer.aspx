                                ...
                                <td>
                                    <div style="float: right; padding-right: 10px;">
                                        <adv:AdvButton ID="btnChangeCommonInfo" runat="server" Width="170" Text="<%$ Resources:Resource, Admin_Update %>"
                                            ...
                                            ValidationGroup="0" Visible="true" OnClick="btnChangeCommonInfo_Click" />
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                                                        ...
                                                                        <tr id="trCustomerRole" runat="server">
                                                                            ...
                                                                            <td>
                                                                                ...
                                                                                <asp:DropDownList ID="ddlCustomerRole" runat="server" Style="width: 200px;">
                                                                                    <asp:ListItem Text="<%$ Resources:Resource, Admin_ViewCustomer_CustomerRole_User %>" Value="0" />
                                                                                    <asp:ListItem Text="<%$ Resources:Resource, Admin_ViewCustomer_CustomerRole_Moderator %>" Value="50" />
                                                                                </asp:DropDownList>
                                                                            </td>
                                                                        </tr>
                                                                    </table>
