<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPageAdmin.master" AutoEventWireup="true"
    CodeFile="CustomersGroups.aspx.cs" Inherits="Admin.CustomersGroups" %>
                    ...
                    <tr>
                        ...
                        <td>
                            <div style="float: right;">
                                ...
                                <div>
                                    <adv:AdvButton ID="btnAddCustomerGroup" runat="server" Width="170" Text="<%$ Resources:Resource, Admin_CustomerGroup_Add %>"
                                        ...
                                        ValidationGroup="0" OnClick="btnAddCustomerGroup_Click" />
                                </div>
                            </div>
                        </td>
                    </tr>
                            ...
                            <adv:AdvGridView ID="grid" runat="server" AllowSorting="true" AutoGenerateColumns="False" CellPadding="2"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField AccessibleHeaderText="GroupName" HeaderStyle-HorizontalAlign="Left">
                                        ...
                                        <EditItemTemplate>
                                            <asp:TextBox ID="txtGroupName" runat="server" Text='<%# Eval("GroupName") %>' Width="99%"></asp:TextBox>
                                        </EditItemTemplate>
                                        <ItemTemplate>
                                    ...
                                    <asp:TemplateField ItemStyle-HorizontalAlign="center" FooterStyle-HorizontalAlign="Center" ItemStyle-Width="90px">
                                        <EditItemTemplate>
                                            ...
                                            <ajaxToolkit:ConfirmButtonExtender ID="ConfirmButtonExtender2" runat="server" TargetControlID="buttonDelete"
                                                ConfirmText="<%$ Resources:Resource, Admin_CustomerGroup_Confirmation %>">
