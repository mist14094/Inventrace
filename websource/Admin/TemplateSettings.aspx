<%@ Page AutoEventWireup="true" CodeFile="TemplateSettings.aspx.cs" Inherits="Admin.TemplateSettings" Language="C#"
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphMain" runat="Server">
    ...
    <div class="content-own">
        ...
        <div style="width:520px; margin: 10px auto;">
            ...
            <asp:HyperLink ID="btnSave" CssClass="tpl-save-btn" runat="server" Text="<%$ Resources:Resource, Admin_TemplateSettings_SaveSettings %>" 
            ...
            <asp:Button ID="btnResizePhoto" runat="server" Text="<%$ Resources:Resource, Admin_ResizePhoto_Resize %>"
                        OnClick="btnResizePhoto_Click"  />
        </div>
    </div>
</asp:Content>
