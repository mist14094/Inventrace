<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPageAdmin.master" AutoEventWireup="true"
    CodeFile="Receiving.aspx.cs" Inherits="Admin.Receiving" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphMain" runat="Server">
    ...
    <div class="content-own">
        ...
        <table>
            <tr> <td>PO No.</td> <td> <asp:TextBox runat="server" ID="txtPONO"></asp:TextBox></td><td>Vendor</td> <td> <asp:TextBox runat="server" ID="txtVendor"></asp:TextBox></td> <td colspan="3"></td> </tr>
            <tr> <td>SKU</td> <td> <asp:DropDownList runat="server" ID="ddlSKU"/></td><td>Desc</td> <td> <asp:DropDownList runat="server" ID="ddlDesc"/> </td>
             <td>Quantity</td> <td> <asp:TextBox runat="server" ID="txtQty"></asp:TextBox></td><td > <asp:Button runat="server" ID="btnAdd" Text="Add"/></td> </tr>
