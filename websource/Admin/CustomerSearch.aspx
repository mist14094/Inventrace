                ...
                <tr>
                    ...
                    <td>
                        <div style="float: right;">
                            <adv:AdvButton ID="btnCreateCustomer" runat="server" Width="170" Text="<%$ Resources:Resource, Admin_CreateCustomer_Header %>"
                                ...
                                OnClick="btnCreateCustomer_Click" />
                        </div>
                    </td>
                </tr>
            </tbody>
                ...
                <table class="filter" style="border-collapse: collapse;" border="0" cellpadding="0"
                    ...
                    <tr>
                        ...
                        <td style="width: 230px; text-align: center;">
                            <div style="width: 230px; height: 0px; font-size: 0px;">
                            </div>
                            <asp:SqlDataSource ID="sdsGroup" runat="server" OnInit="sds_Init" SelectCommand="SELECT CustomerGroupId, (GroupName + ' - ' + CAST(GroupDiscount AS nvarchar(20)) + '%') as [Name] FROM [Customers].[CustomerGroup] ORDER BY GroupDiscount">
                            </asp:SqlDataSource>
                        ...
                        <td style="width: 180px;">
                            ...
                            <table cellpadding="1px;" cellspacing="0px;" style="margin-left: 5px;">
                                <tr>
                                    ...
                                    <td>
                                        <asp:Image ID="popupDateFrom" runat="server" ImageUrl="~/Admin/images/Calendar_scheduleHS.png" /><%--<ajaxToolkit:CalendarExtender
                                            TargetControlID="txtDateFrom" PopupButtonID="popupDateFrom" CssClass="popupCalendar"
                                            BehaviorID="calendar" Format="yyyy-MM-dd" ID="CalendarExtender1" runat="server"
                                            PopupPosition="Right">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:Image ID="popupDateTo" runat="server" ImageUrl="~/Admin/images/Calendar_scheduleHS.png" /><%--<ajaxToolkit:CalendarExtender
                                            TargetControlID="txtDateTo" PopupButtonID="popupDateTo" CssClass="popupCalendar"
                                            BehaviorID="calendar2" Format="yyyy-MM-dd" ID="CalendarExtender2" runat="server"
                                            PopupPosition="Right">
                                        </ajaxToolkit:CalendarExtender>--%>
                                    </td>
                                </tr>
                ...
                <ContentTemplate>
                    <adv:AdvGridView ID="advCustomers" runat="server" AllowSorting="true" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField AccessibleHeaderText="CustomerGroup" ItemStyle-Width="230" ItemStyle-HorizontalAlign="Center"
                            ...
                            <asp:TemplateField ItemStyle-HorizontalAlign="center" ItemStyle-Width="90px">
                                <EditItemTemplate>
                                    ...
                                    <a href='<%#"ViewCustomer.aspx?CustomerID=" + Eval("ID")%>' class="deletebtn showtooltip"
                                    ...
                                    <asp:ImageButton ID="buttonDelete" runat="server" ImageUrl="images/deletebtn.png"
                                        CssClass="deletebtn showtooltip" CommandName="DeleteAll" ToolTip="<%$ Resources:Resource, Admin_CustomersSearch_Delete %>"
                                        CommandArgument='<%# Eval("ID") %>' Visible='<%# (string)Eval("Email") != "admin" %>' />
                                    <ajaxToolkit:ConfirmButtonExtender ID="ConfirmButtonExtender2" runat="server" TargetControlID="buttonDelete"
                                        ConfirmText="<%$ Resources:Resource, Admin_CustomersSearch_Confirmation %>">
