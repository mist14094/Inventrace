...
<asp:Content ID="Content2" ContentPlaceHolderID="cphMain" runat="Server">
    <div class="content-own">
        ...
        <div class="panel-add">
            <a href="EditOrder.aspx" class="panel-add-lnk"> <%= Resource.Admin_MasterPageAdmin_Add %> <%= Resource.Admin_MasterPageAdmin_Order %></a>
        </div>
    </div>
        <div>
                                    ...
                                    <asp:TemplateField AccessibleHeaderText="ProductName" HeaderStyle-HorizontalAlign="Left">
                                        <HeaderTemplate>
                                            ...
                                            <asp:LinkButton ID="lbProductName" runat="server" CommandName="Sort" CommandArgument="ProductName">
                                                ...
                                                <asp:Image ID="arrowProductName" CssClass="arrow" runat="server" ImageUrl="images/arrowdownh.gif" /></asp:LinkButton>
                                        </HeaderTemplate>
                                        <ItemTemplate>
                                    ...
                                    <asp:TemplateField AccessibleHeaderText="Phone" HeaderStyle-HorizontalAlign="Left"
                                        ...
                                        <HeaderTemplate>
                                            ...
                                            <asp:LinkButton ID="lbPhone" runat="server" CommandName="Sort" CommandArgument="Phone">
                                                ...
                                                <asp:Image ID="arrowPhone" CssClass="arrow" runat="server" ImageUrl="images/arrowdownh.gif" /></asp:LinkButton>
                                        </HeaderTemplate>
                                        <ItemTemplate>
                                    ...
                                    <asp:TemplateField AccessibleHeaderText="IsComplete" HeaderStyle-HorizontalAlign="Left"
                                        ...
                                        <HeaderTemplate>
                                            ...
                                            <asp:LinkButton ID="lbIsComplete" runat="server" CommandName="Sort" CommandArgument="IsComplete">
                                                ...
                                                <asp:Image ID="arrowIsComplete" CssClass="arrow" runat="server" ImageUrl="images/arrowdownh.gif" /></asp:LinkButton>
                                        </HeaderTemplate>
                                        <ItemTemplate>
                                    ...
                                    <asp:TemplateField AccessibleHeaderText="RequestDate" HeaderStyle-HorizontalAlign="Left"
                                        ...
                                        <HeaderTemplate>
                                            <asp:LinkButton ID="lbRequestDate" runat="server" CommandName="Sort" CommandArgument="RequestDate">
                                                ...
                                                <asp:Image ID="arrowRequestDate" CssClass="arrow" runat="server" ImageUrl="images/arrowdownh.gif" /></asp:LinkButton>
                                        </HeaderTemplate>
                                        <ItemTemplate>
                                    ...
                                    <asp:TemplateField ItemStyle-HorizontalAlign="center" FooterStyle-HorizontalAlign="Center"
                                        ...
                                        <ItemTemplate> 
                                            ...
                                            <asp:ImageButton ID="buttonDelete" runat="server" ImageUrl="images/deletebtn.png"
                                                CssClass="deletebtn showtooltip" CommandName="DeleteOrderByRequest" CommandArgument='<%# Eval("ID")%>'
                                            ...
                                            <ajaxToolkit:ConfirmButtonExtender ID="ConfirmButtonExtender2" runat="server" TargetControlID="buttonDelete"
                                                ConfirmText="<%$ Resources:Resource, Admin_OrderByRequest_Confirmation %>">
