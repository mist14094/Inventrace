<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPageAdmin.master" AutoEventWireup="true"
    CodeFile="Brands.aspx.cs" Inherits="Admin.Brands" %>
            ...
            <div>
                <div>
                    <adv:AdvButton ID="btnAdd" runat="server" Width="170" Text="<%$ Resources:Resource, Admin_HeadCmdInsert %>"
                        ...
                        CssCenterDiv="adv_OrangeButton_CenterDiv" OnClientClick="javascript:open_window('m_Brand.aspx',750,600);return false;" />
                </div>
                                    ...
                                    <asp:TemplateField ItemStyle-HorizontalAlign="Center" FooterStyle-HorizontalAlign="Center">
                                        <EditItemTemplate>
                                            ...
                                            <asp:ImageButton ID="buttonDelete" runat="server" ImageUrl="images/deletebtn.png"
                                                CssClass="deletebtn showtooltip" CommandName="DeleteBrand" CommandArgument='<%# Eval("ID")%>'
                                            ...
                                            <ajaxToolkit:ConfirmButtonExtender ID="ConfirmButtonExtender2" runat="server" TargetControlID="buttonDelete"
                                                ConfirmText='<%# String.Format(Resources.Resource.Admin_Brands_DeleteConfirm, Eval("BrandName")) %>'>
