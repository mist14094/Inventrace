                ...
                <div style="width: 100%;">
                    ...
                    <center>
                        <table style="width: 210px; text-align: center; margin-bottom: 20px; margin-top: 10px;">
                            <tr>
                                <td>
                                    <adv:AdvButton ID="SaveAll" runat="server" Width="170" Text="<%$ Resources:Resource, Admin_m_CategorySortOrder_Save %>"
                                        ...
                                        CssCenterDiv="adv_OrangeButton_CenterDiv" ValidationGroup="0" OnClick="SaveAll_Click" />
                                </td>
                                <td style="width: 10px">
                                    &nbsp;
                                </td>
                            ...
                            <tr>
                                <td colspan="2">
                                    <asp:Button ID="btnOK" runat="server" Text="<%$ Resources:Resource, Admin_m_CategorySortOrder_Close %>"
