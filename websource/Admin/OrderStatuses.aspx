                        ...
                        <tbody>
                            <tr>
                                ...
                                <td style="text-align: right">
                                    <adv:OrangeRoundedButton runat="server" ID="btnAddStatus" OnClick="btnAddStatus_Click"
                            ...
                            <tr>
                                <td>
                                    <span class="admin_catalog_commandBlock"><span style="display: inline-block; margin-right: 3px;">
                                        ...
                                        |</span><span id="selectedIdsCount" class="bold"><%= SelectedCount() %></span>&nbsp;<span><%=Resources.Resource.Admin_Catalog_ItemsSelected %></span></span></span>
                                </td>
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField AccessibleHeaderText="IsDefault" ItemStyle-HorizontalAlign="Center"
                                                ...
                                                <EditItemTemplate>
                                                    <adv:PlainCheckBox runat="server" ID="chkIsDefault" Checked='<%# Eval("IsDefault") %>'
                                                        Enabled='<%# !(SQLDataHelper.GetBoolean(Eval("IsCanceled")) || SQLDataHelper.GetBoolean(Eval("IsDefault"))) %>'
                                                        CssClass='<%# "switchCheckbox" + ((SQLDataHelper.GetBoolean(Eval("IsCanceled")) || SQLDataHelper.GetBoolean(Eval("IsDefault"))) ? " add" : "")  %>'>
                                                    </adv:PlainCheckBox>
                                                </EditItemTemplate>
                                                <FooterTemplate>
                                                    <asp:CheckBox ID="chkIsDefaultAdd" CssClass="switchCheckbox add" runat="server">
                                                    </asp:CheckBox>
                                                </FooterTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField AccessibleHeaderText="IsCanceled" ItemStyle-HorizontalAlign="Center"
                                                ...
                                                <HeaderTemplate>
                                                    ...
                                                    <asp:LinkButton ID="lbOrderCanceled" runat="server" CommandName="Sort" CommandArgument="Canceled">
                                            ...
                                            <asp:TemplateField ItemStyle-Width="100" HeaderStyle-Width="100" AccessibleHeaderText="Buttons"
                                                ...
                                                <EditItemTemplate>
                                                    <asp:ImageButton ID="buttonDelete" runat="server" ImageUrl="images/deletebtn.png"
                                                        CssClass="deletebtn showtooltip" CommandName="StatusDelete" CommandArgument='<%# Eval("ID")%>'
                                                        ToolTip='<%$ Resources:Resource, Admin_MasterPageAdminCatalog_Delete %>' Visible='<%# OrderService.StatusCanBeDeleted((int)Eval("ID")) %>' />
                                                    <ajaxToolkit:ConfirmButtonExtender ID="ConfirmButtonExtenderbuttonDelete" runat="server"
                                                        TargetControlID="buttonDelete" ConfirmText="<%$ Resources: Resource, Admin_OrderStatuses_Confirmation %>">
