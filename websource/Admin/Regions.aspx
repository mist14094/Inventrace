            ...
            <tbody>
                <tr>
                    ...
                    <td>
                        ...
                        <asp:Label ID="lblSubHead" CssClass="AdminSubHead" runat="server" Text="<%$ Resources:Resource, Admin_Region_SubHeader %>"></asp:Label>
                    </td>
                    <td style="vertical-align: bottom; padding-right: 10px">
                        <div style="float: right; padding-right: 10px">
                            <adv:AdvButton ID="btnAddRegion" runat="server" Width="170" Text="<%$ Resources:Resource, Admin_Region_Add %>"
                                ...
                                CssCenterDiv="adv_OrangeButton_CenterDiv" ValidationGroup="0" OnClick="btnAddRegion_Click" />
                        </div>
                    </td>
                </tr>
            </tbody>
                        ...
                        <adv:AdvGridView ID="grid" runat="server" AllowSorting="true" AutoGenerateColumns="False"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField AccessibleHeaderText="RegionName" HeaderStyle-HorizontalAlign="Left">
                                    ...
                                    <ItemTemplate>
                                        <asp:Label ID="lRegionName" runat="server" Text='<%# Bind("RegionName") %>'></asp:Label>
                                    </ItemTemplate>
                                    <FooterTemplate>
                                ...
                                <asp:TemplateField AccessibleHeaderText="RegionCode" HeaderStyle-HorizontalAlign="Left"
                                    ...
                                    <EditItemTemplate>
                                        <asp:TextBox ID="txtNumber" runat="server" Text='<%# Eval("RegionCode") %>' Width="99%"></asp:TextBox>
                                    </EditItemTemplate>
                                    <ItemTemplate>
                                        <asp:Label ID="lNumber" runat="server" Text='<%# Bind("RegionCode") %>'></asp:Label>
                                    </ItemTemplate>
                                    <FooterTemplate>
                                        <asp:TextBox ID="txtNewNumber" CssClass="add" runat="server" Text='' Width="99%"></asp:TextBox>
                                    </FooterTemplate>
                                </asp:TemplateField>
                                ...
                                <asp:TemplateField ItemStyle-Width="90px" HeaderStyle-Width="90px" ItemStyle-HorizontalAlign="center" ItemStyle-CssClass="tdCommands"
                                    ...
                                    <EditItemTemplate>
                                        ...
                                        <asp:ImageButton ID="buttonDelete" runat="server" ImageUrl="images/deletebtn.png"
                                            CssClass="deletebtn showtooltip" CommandName="DeleteRegion" CommandArgument='<%# Eval("ID")%>'
                                            ToolTip='<%$ Resources:Resource, Admin_MasterPageAdminCatalog_Delete %>' Visible='<%# Convert.ToInt32(Eval("ID")) != SettingsMain.SalerRegionId%>' />
                                        <ajaxToolkit:ConfirmButtonExtender ID="ConfirmButtonExtender2" runat="server" TargetControlID="buttonDelete"
                                            ConfirmText="<%$ Resources:Resource, Admin_Region_Confirmation %>">
