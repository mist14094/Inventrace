<%@ Page Title="ExportFeed" Language="C#" MasterPageFile="~/Admin/MasterPageAdmin.master" AutoEventWireup="true"
    CodeFile="ExportFeedDet.aspx.cs" Inherits="Admin.ExportFeedDet" %>
                ...
                <div id="tabs-1" class="ui-tabs-panel">
                    <table border="0" cellpadding="2" cellspacing="0" style="width: 100%;">
                        ...
                        <tr class="settingsRow ">
                            ...
                            <td class="parametrValue">
                                <span class="parametrValueString">
                                    <asp:Literal ID="lShopUrl" runat="Server" /><asp:TextBox Width="150px" ID="FileNameTextBox" runat="Server" />.<asp:Literal
                        ...
                        <tr id="Delivery" class="settingsRow" visible="false" runat="Server">
                            ...
                            <td class="parametrValue">
                                <span class="parametrValueString">
                                    <asp:CheckBox runat="server" ID="chbDelivery" />
                                </span>
                            </td>
                        </tr>
