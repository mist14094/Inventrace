<%@ Page Language="C#" MasterPageFile="~/Admin/MasterPageAdmin.master" AutoEventWireup="false" CodeFile="Discount_PriceRange.aspx.cs"
    Inherits="Admin.DiscountsPriceRange" %>
                                    ...
                                    <adv:AdvGridView ID="grid" runat="server" AllowSorting="true" AutoGenerateColumns="False"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField AccessibleHeaderText="PriceRange" ItemStyle-HorizontalAlign="Center"
                                                ...
                                                <ItemTemplate>
                                                    <asp:Label ID="lblPriceRange" runat="server" Text='<%# AdvantShop.Helpers.SQLDataHelper.GetFloat(Eval("PriceRange")).ToString("F2") %>'></asp:Label>
                                                </ItemTemplate>
                                                <EditItemTemplate>
