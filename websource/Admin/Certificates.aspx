<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPageAdmin.master" AutoEventWireup="true"
    CodeFile="Certificates.aspx.cs" Inherits="Admin.Certificates" %>
            ...
            <div>
                <div>
                    <adv:AdvButton ID="btnAdd" runat="server" Width="170" Text="<%$ Resources:Resource, Admin_HeadCmdInsert %>"
                        ...
                        CssLeftDiv="adv_OrangeButton_LeftDiv" CssRightDiv="adv_OrangeButton_RightDiv" CssCenterDiv="adv_OrangeButton_CenterDiv"
                        OnClientClick="javascript:window.open('../giftcertificate.aspx');" />
                        <adv:AdvButton ID="btnSettings" runat="server" Width="170" Text="<%$ Resources:Resource, Admin_Certificates_Settings %>"
                        CssMain="adv_OrangeButton_Main" CssInput="adv_OrangeButton_Input" CssInputMozz="adv_OrangeButton_Input-mozz"
                        CssLeftDiv="adv_OrangeButton_LeftDiv" CssRightDiv="adv_OrangeButton_RightDiv" CssCenterDiv="adv_OrangeButton_CenterDiv" OnClick="btnSettings_Click"
                        />
                </div>
                        ...
                        <table class="filter" cellpadding="0" cellspacing="0">
                            ...
                            <tr>
                                ...
                                <td style="text-align: center;">
                                    ...
                                    <asp:TextBox CssClass="filtertxtbox" ID="txtCertificateCode" Width="100" runat="server" TabIndex="12" />
                                </td>
                                <td style="width: 200px; text-align: center;">
                                    <div style="width: 200px; height: 0px; font-size: 0px;">
                                    </div>
                                    <asp:TextBox CssClass="filtertxtbox" ID="txtOrderNumber" Width="220" runat="server" TabIndex="12" />
                                </td>
                                <td style="width: 200px; text-align: left;">
                                    <div style="width: 200px; height: 0px; font-size: 0px;">
                                    </div>
                                    <asp:TextBox CssClass="filtertxtbox" ID="txtSumFilter" Width="99%" runat="server" TabIndex="12" />
                                </td>
                                <td style="width: 200px; text-align: left;">
                                    <div style="width: 200px; height: 0px; font-size: 0px;">
                                    </div>
                                ...
                                <td style="width: 250px; text-align: center;">
                                    ...
                                    <asp:TextBox CssClass="filtertxtbox" ID="txtCreationDate" Width="99%" runat="server" TabIndex="12" />
                                </td>
                                <td style="width: 95px;">
                        ...
                        <ContentTemplate>
                            <adv:AdvGridView ID="grid" runat="server" AllowSorting="true" AutoGenerateColumns="False" CellPadding="0"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField AccessibleHeaderText="CertificateCode" HeaderStyle-HorizontalAlign="Left" HeaderStyle-Width="140px"
                                        ...
                                        <EditItemTemplate>
                                            <asp:Label ID="lblCertificateCode" runat="server" Text='<%# Eval("CertificateCode") %>' Width="99%"></asp:Label>
                                        </EditItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField AccessibleHeaderText="OrderID" HeaderStyle-HorizontalAlign="Left" HeaderStyle-Width="200px"
                                        ...
                                        <HeaderTemplate>
                                            ...
                                            <asp:LinkButton ID="lbOrderID" runat="server" CommandName="Sort" CommandArgument="OrderID">
                                                ...
                                                <asp:Image ID="arrowOrderID" CssClass="arrow" runat="server" ImageUrl="images/arrowdownh.gif" /></asp:LinkButton>
                                        </HeaderTemplate>
                                        <EditItemTemplate>
                                    ...
                                    <asp:TemplateField AccessibleHeaderText="OrderNumber" HeaderStyle-HorizontalAlign="Left" HeaderStyle-Width="200px"
                                        ItemStyle-Width="200px">
                                        <HeaderTemplate>
                                            <div style="width: 200px; height: 0px; font-size: 0px;">
                                            </div>
                                            <asp:LinkButton ID="lbOrderNumber" runat="server" CommandName="Sort" CommandArgument="OrderNumber">
                                                <%=Resources.Resource.Admin_CertificateAdmin_OrderNumber%>
                                    ...
                                    <asp:TemplateField AccessibleHeaderText="Sum" HeaderStyle-HorizontalAlign="Left" HeaderStyle-Width="200px"
                                        ItemStyle-Width="200px">
                                        <HeaderTemplate>
                                    ...
                                    <asp:TemplateField AccessibleHeaderText="Paid" ItemStyle-Width="85" HeaderStyle-Width="85" HeaderStyle-HorizontalAlign="Left"
                                    ...
                                    <asp:TemplateField AccessibleHeaderText="Enable" HeaderStyle-HorizontalAlign="Left" HeaderStyle-Width="110px"
                                    ...
                                    <asp:TemplateField AccessibleHeaderText="Used" HeaderStyle-HorizontalAlign="Left" HeaderStyle-Width="140px"
                                        ItemStyle-Width="140px">
                                        <HeaderTemplate>
                                    ...
                                    <asp:TemplateField AccessibleHeaderText="CreationDate" HeaderStyle-HorizontalAlign="Left" HeaderStyle-Width="250px"
                                    ...
                                    <asp:TemplateField ItemStyle-Width="95px" HeaderStyle-Width="95px" ItemStyle-HorizontalAlign="Center"
                                        ...
                                        <EditItemTemplate>
                                            ...
                                            <asp:ImageButton ID="buttonDelete" runat="server" ImageUrl="images/deletebtn.png" CssClass="deletebtn showtooltip"
                                                CommandName="DeleteCertificate" CommandArgument='<%# Eval("ID")%>' ToolTip='<%$ Resources:Resource, Admin_MasterPageAdminCatalog_Delete %>' />
                                            ...
                                            <input id="btnCancel" name="btnCancel" class="cancelbtn showtooltip" type="image" src="images/cancelbtn.png"
                                                onclick="row_canceledit($(this).parent().parent()[0]);return false;" style="display: none" title="<%=Resource.Admin_MasterPageAdminCatalog_Cancel %>" />
                                        </EditItemTemplate>
                                    </asp:TemplateField>
                                </Columns>
