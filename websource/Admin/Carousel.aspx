<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPageAdmin.master" AutoEventWireup="true"
    CodeFile="Carousel.aspx.cs" Inherits="Admin.Carouseles" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphMain" runat="Server">
    ...
    <div class="content-own">
        <div>
            ...
            <table cellpadding="0" class="tableCarousel" width="100%" cellspacing="0" style="padding-left: 10px;
                padding-right: 10px">
                <tr>
                ...
                <tr>
                    ...
                    <td style="color: Red;">
                        <asp:TextBox ID="txtSortedCarousel" runat="server">
                        </asp:TextBox>*
                    </td>
                </tr>
                <tr>
                                    ...
                                    <asp:TemplateField ItemStyle-HorizontalAlign="center" FooterStyle-HorizontalAlign="Center"
                                        ...
                                        <EditItemTemplate>
                                            ...
                                            <asp:ImageButton ID="buttonDelete" runat="server" ImageUrl="images/deletebtn.png"
                                                CssClass="deletebtn showtooltip" CommandName="DeleteCarousel" CommandArgument='<%# Eval("ID")%>'
                                            ...
                                            <ajaxToolkit:ConfirmButtonExtender ID="ConfirmButtonExtender2" runat="server" TargetControlID="buttonDelete"
                                                ConfirmText="<%$ Resources:Resource, Admin_Caroucel_Confirmation %>">
