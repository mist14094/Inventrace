    ...
    <div style="margin: 15px 10px 0px 20px;">
        ...
        <table cellpadding="0" cellspacing="0" style="width: 100%;">
            <tr>
                ...
                <td style="width: 105px;">
                    <adv:OrangeRoundedButton CausesValidation="false" ID="btnSave" runat="server" Text='<%$ Resources:Resource, Admin_Update %>'
                        OnClick="btnSave_Click" />
                </td>
                <td style="width: 150px;">
                    <adv:OrangeRoundedButton CausesValidation="false" ID="btnDeleteOrder" runat="server"
        ...
        <div class="style3">
            <div style="width: 260px; float: left;">
                <adv:OrangeRoundedButton CausesValidation="false" ID="btnSendLink" runat="server"
        ...
        <div class="style3">
            <div style="width: 415px; float: left;">
                <adv:OrangeRoundedButton CausesValidation="false" ID="btnSentFailure" runat="server"
                    Text='<%$ Resources:Resource, Admin_OrderByRequest_SendFailure %>' 
                    Width="400px" onclick="btnSentFailure_Click" />
            </div>
            <div style="float: left;">
