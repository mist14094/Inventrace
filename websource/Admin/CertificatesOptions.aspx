<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPageAdmin.master" AutoEventWireup="true"
    CodeFile="CertificatesOptions.aspx.cs" Inherits="Admin.CertificatesOptions" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphMain" runat="Server">
    ...
    <div class="content-own">
                ...
                <ItemTemplate>
                    <tr>
                        <td>
                            ...
                            <asp:CheckBox ID="ckbActive" runat="server" Checked='<%# GiftCertificateTaxes.Any(item=>item == Convert.ToInt32(Eval("TaxId"))) %>' />
                        </td>
                        <td>
                            <%# Eval("Name") %>
                        </td>
        ...
        <div style="margin: 20px auto; width: 400px">
            <asp:ListView ID="lvPaymentMethods" runat="server" ItemPlaceholderID="itemPlaceHolderID">
                ...
                <ItemTemplate>
                    <tr>
                        <td>
                            <asp:CheckBox ID="ckbActive" runat="server" Checked='<%# GiftCertificatePaymentMethods.Any(item=>item == Convert.ToInt32(Eval("PaymentMethodId"))) %>' />
        ...
        <div style="text-align: center">
            <asp:Button ID="btnSave" runat="server" Text="<%$ Resources:Resource, Admin_Certificates_Save %>"
