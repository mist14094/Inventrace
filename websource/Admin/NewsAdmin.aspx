<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPageAdmin.master" AutoEventWireup="true"
    CodeFile="NewsAdmin.aspx.cs" Inherits="Admin.News" %>
                ...
                <div>
                    <div>
                        <adv:AdvButton ID="btnAdd" runat="server" Width="170" Text="<%$ Resources:Resource, Admin_HeadCmdInsert %>"
                            ...
                            CssCenterDiv="adv_OrangeButton_CenterDiv" OnClientClick="javascript:open_window('m_News.aspx',750,600);return false;" />
                    </div>
                            ...
                            <td>
                                <span class="admin_catalog_commandBlock"><span style="display: inline-block; margin-right: 3px;">
                                    ...
                                    <select id="commandSelect" onchange="ChangeCategory();">
                                        ...
                                        <option value="setOutMainPage">
                                            <asp:Localize ID="Localize8" runat="server" Text="<%$ Resources:Resource, Admin_NewsAdmin_ShowOnMain %>"></asp:Localize>
                                        </option>
                                        <option value="changeCategoryNews">
                                            <asp:Localize ID="Localize9" runat="server" Text="<%$ Resources:Resource, Admin_NewsAdmin_ChangeCategory %>"></asp:Localize>
                                        </option>
                                    </select>
                                ...
                                <adv:AdvGridView ID="grid" runat="server" AllowSorting="true" AutoGenerateColumns="False"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField AccessibleHeaderText="Title" HeaderStyle-HorizontalAlign="Left">
                                            ...
                                            <EditItemTemplate>
                                                <asp:TextBox ID="txtTitle" runat="server" Text='<%# Eval("Title") %>' Width="99%"></asp:TextBox>
                                            </EditItemTemplate>
                                            <ItemTemplate>
                                        ...
                                        <asp:TemplateField ItemStyle-Width="85px" HeaderStyle-Width="85px" ItemStyle-HorizontalAlign="Center"
                                            ...
                                            <EditItemTemplate>
                                                ...
                                                <asp:ImageButton ID="buttonDelete" runat="server" ImageUrl="images/deletebtn.png"
                                                    CssClass="deletebtn showtooltip" CommandName="DeleteNews" CommandArgument='<%# Eval("ID")%>'
                                                ...
                                                <ajaxToolkit:ConfirmButtonExtender ID="ConfirmButtonExtender2" runat="server" TargetControlID="buttonDelete"
                                                    ConfirmText="<%$ Resources:Resource, Admin_NewsAdmin_Confirmation %>">
