<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPageAdmin.master" AutoEventWireup="true"
    CodeFile="Menu.aspx.cs" Inherits="Admin.Menu" %>
                            ...
                            <tr>
                                ...
                                <td colspan="2">
                                    <div>
                                        ...
                                        <asp:LinkButton ID="hlDeleteCategory" CssClass="blueLink" runat="server" Text="<%$ Resources:Resource, Admin_MasterPageAdminCatalog_FPanel_DeleteMenu %>"
                                    ...
                                    <div style="float: right; margin-top: 10px;">
                                        <adv:AdvButton ID="btnAdd" runat="server" Width="200" Text="<%$ Resources:Resource, Admin_HeadCmdInsertMenu %>"
                                            ...
                                            CssCenterDiv="adv_OrangeButton_CenterDiv2" />
                                    </div>
                                </td>
                            </tr>
                        </tbody>
                                                ...
                                                <asp:TemplateField ItemStyle-Width="100px" ItemStyle-HorizontalAlign="Left" FooterStyle-HorizontalAlign="Center">
                                                    <EditItemTemplate>
                                                        ...
                                                        <asp:ImageButton ID="buttonDelete" runat="server" ImageUrl="images/deletebtn.png"
                                                            CssClass="deletebtn showtooltip" CommandName="DeleteItem" CommandArgument='<%# Eval("ID")%>'
                                                        ...
                                                        <ajaxToolkit:ConfirmButtonExtender ID="ConfirmButtonExtender2" runat="server" TargetControlID="buttonDelete"
                                                            ConfirmText='<%$Resources:Resource, Admin_MenuManager_DeleteItem %>'>
                                                        </ajaxToolkit:ConfirmButtonExtender>
