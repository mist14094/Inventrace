...
<asp:Content ID="Content2" ContentPlaceHolderID="cphMain" runat="Server">
    ...
    <div class="content-own">
        ...
        <div style="width: 100%">
            <div>
                <div>
                    <adv:AdvButton ID="btnAddColor" runat="server" Width="170" Text="<%$ Resources:Resource, Admin_ColorsDictionary_AddColor %>"
                        ...
                        CssCenterDiv="adv_OrangeButton_CenterDiv" ValidationGroup="0" OnClick="btnAddColor_Click" />
                </div>
                            ...
                            <adv:AdvGridView ID="grid" runat="server" AllowSorting="true" AutoGenerateColumns="False"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField AccessibleHeaderText="ColorCode" HeaderStyle-HorizontalAlign="Left"
                                        ...
                                        <FooterTemplate>
                                            <asp:TextBox ID="txtNewColorCode" runat="server" Text="000000" MaxLength="7" Style="display: none;"></asp:TextBox>
                                            <span class="jPicker">
                                                <span class="Icon">
                                                    <span class="Color" style="background: <%# Eval("ColorCode") %>">&nbsp;</span>
                                                    <span class="Alpha">&nbsp;</span>
