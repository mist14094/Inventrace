            ...
            <table style="width: 100%" cellspacing="0" cellpadding="0" border="0">
                <tr>
                    ...
                    <td style="width: 100%; vertical-align: top; padding: 0px 0 0 10px;">
                        ...
                        <div>
                            <div>
                                <adv:AdvButton ID="btnAddPage" runat="server" Width="170" Text="<%$ Resources:Resource, Admin_HeadCmdInsert %>"
                                    ...
                                    CssCenterDiv="adv_OrangeButton_CenterDiv" OnClick="btnAddPage_Click" />
                            </div>
                                        ...
                                        <adv:AdvGridView ID="grid" runat="server" AllowSorting="true" AutoGenerateColumns="False"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField AccessibleHeaderText="PageName" HeaderStyle-HorizontalAlign="Left">
                                                    ...
                                                    <EditItemTemplate>
                                                        <asp:TextBox ID="txtPageName" runat="server" Text='<%# Eval("PageName") %>' Width="99%"></asp:TextBox>
                                                    </EditItemTemplate>
                                                    <ItemTemplate>
                                                ...
                                                <asp:TemplateField HeaderStyle-Width="60px" ItemStyle-HorizontalAlign="Center">
                                                    <EditItemTemplate>
                                                        ...
                                                        <asp:ImageButton ID="buttonDelete" runat="server" ImageUrl="images/deletebtn.png"
                                                            CssClass="deletebtn showtooltip" CommandName="DeletePage" CommandArgument='<%# Eval("ID")%>'
