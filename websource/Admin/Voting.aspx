...
<asp:Content ID="Content2" ContentPlaceHolderID="cphMain" runat="Server">
    ...
    <div class="content-own">
        ...
        <div style="width: 100%">
            <div>
                <div>
                    <adv:AdvButton ID="btnAdd" runat="server" Width="170" Text="<%$ Resources:Resource, Admin_HeadCmdInsertVoiting %>"
                            ...
                            <adv:AdvGridView ID="grid" runat="server" AllowSorting="true" AutoGenerateColumns="False" CellPadding="0"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField AccessibleHeaderText="IsDefault" ItemStyle-HorizontalAlign="Center" FooterStyle-HorizontalAlign="Center"
                                        ...
                                        <HeaderTemplate>
                                            <asp:LinkButton ID="lbOrderIsDefault" runat="server" CommandName="Sort" CommandArgument="IsDefault">
                                                ...
                                                <asp:Image ID="arrowIsDefault" CssClass="arrow" runat="server" ImageUrl="images/arrowdownh.gif" /></asp:LinkButton>
                                        </HeaderTemplate>
                                        <EditItemTemplate>
                                            <asp:CheckBox ID="chkIsDefault" runat="server" Checked='<%# Bind("IsDefault") %>' />
                                        </EditItemTemplate>
                                        <ItemTemplate>
                                            <asp:CheckBox ID="chkIsDefault" runat="server" Checked='<%# Bind("IsDefault") %>' Enabled="false" />
                                        </ItemTemplate>
                                        <FooterTemplate>
                                    ...
                                    <asp:TemplateField AccessibleHeaderText="IsHaveNullVoice" ItemStyle-HorizontalAlign="Center" FooterStyle-HorizontalAlign="Center"
                                        ...
                                        <ItemTemplate>
                                            <asp:CheckBox ID="chkIsHaveNullVoice" runat="server" Checked='<%# Bind("IsHaveNullVoice") %>' Enabled="false" />
                                        </ItemTemplate>
                                        <FooterTemplate>
                                    ...
                                    <asp:TemplateField AccessibleHeaderText="IsClose" ItemStyle-HorizontalAlign="Center" FooterStyle-HorizontalAlign="Center"
                                        ...
                                        <HeaderTemplate>
                                            <asp:LinkButton ID="lbOrderIsClose" runat="server" CommandName="Sort" CommandArgument="IsClose">
                                                ...
                                                <asp:Image ID="arrowIsClose" CssClass="arrow" runat="server" ImageUrl="images/arrowdownh.gif" /></asp:LinkButton>
                                        </HeaderTemplate>
                                        <EditItemTemplate>
                                            <asp:CheckBox ID="chkIsClose" runat="server" Checked='<%# Bind("IsClose") %>' />
                                        </EditItemTemplate>
                                        <ItemTemplate>
                                            <asp:CheckBox ID="chkIsClose" runat="server" Checked='<%# Bind("IsClose") %>' Enabled="false" />
                                        </ItemTemplate>
                                        <FooterTemplate>
                                    ...
                                    <asp:TemplateField AccessibleHeaderText="AnswerCount" HeaderStyle-HorizontalAlign="Left" ItemStyle-Width="120px"
                                        ...
                                        <HeaderTemplate>
                                            <asp:LinkButton ID="lbOrderAnswerCount" runat="server" CommandName="Sort" CommandArgument="AnswerCount">
                                                ...
                                                <asp:Image ID="arrowAnswerCount" CssClass="arrow" runat="server" ImageUrl="images/arrowdownh.gif" Style="margin-top: 7px;
                                                    margin-left: 0px;" />
                                            </asp:LinkButton>
                                        </HeaderTemplate>
                                        <ItemTemplate>
                                    ...
                                    <asp:TemplateField SortExpression="DateAdded" HeaderText="<%$ Resources:Resource, Admin_AddDate %>">
                                        ...
                                        <HeaderTemplate>
                                            <asp:LinkButton ID="lbOrderDateAdded" runat="server" CommandName="Sort" CommandArgument="DateAdded">
                                                ...
                                                <asp:Image ID="arrowDateAdded" CssClass="arrow" runat="server" ImageUrl="images/arrowdownh.gif" Style="margin-top: 7px;
                                                    margin-left: 0px;" />
                                            </asp:LinkButton>
                                        </HeaderTemplate>
                                        <ItemTemplate>
                                    ...
                                    <asp:TemplateField ItemStyle-Width="60px" HeaderStyle-Width="60px" ItemStyle-HorizontalAlign="Center"
                                        ...
                                        <EditItemTemplate>
                                            ...
                                            <asp:ImageButton ID="buttonDelete" runat="server" ImageUrl="images/deletebtn.png" CssClass="deletebtn showtooltip"
                                                CommandName="DeleteTheme" CommandArgument='<%# Eval("ID")%>' ToolTip='<%$ Resources:Resource, Admin_MasterPageAdminCatalog_Delete %>' />
                                            <ajaxToolkit:ConfirmButtonExtender ID="ConfirmButtonExtender2" runat="server" TargetControlID="buttonDelete"
                                                ConfirmText="<%$ Resources:Resource, Admin_Voting_Confirmation %>">
