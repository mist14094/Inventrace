<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPageAdmin.master" AutoEventWireup="true"
    CodeFile="StaticBlocks.aspx.cs" Inherits="Admin.StaticBlocks" %>
    ...
    <div class="content-own">
        <div>
            ...
            <div style="width: 100%">
                <div>
                    <div>
                        <adv:AdvButton ID="btnAddBlock" runat="server" Width="170" Text="<%$ Resources:Resource, Admin_HeadCmdInsert %>"
                            ...
                            CssCenterDiv="adv_OrangeButton_CenterDiv" OnClientClick="open_window('m_StaticBlock.aspx?ID=addnew', 750, 640);return false;" />
                    </div>
                                        ...
                                        <asp:TemplateField AccessibleHeaderText="[Key]" HeaderStyle-HorizontalAlign="Left"
                                            ...
                                            <HeaderTemplate>
                                                <asp:LinkButton ID="lbOrderKey" runat="server" CommandName="Sort" CommandArgument="[Key]">
                                                    ...
                                                    <asp:Image ID="arrowKey" CssClass="arrow" runat="server" ImageUrl="images/arrowdownh.gif" /></asp:LinkButton>
                                            </HeaderTemplate>
                                            <EditItemTemplate>
                                        ...
                                        <asp:TemplateField AccessibleHeaderText="InnerName" HeaderStyle-HorizontalAlign="Left">
                                            <HeaderTemplate>
                                                <asp:LinkButton ID="lbOrderInnerName" runat="server" CommandName="Sort" CommandArgument="InnerName">
                                                    ...
                                                    <asp:Image ID="arrowInnerName" CssClass="arrow" runat="server" ImageUrl="images/arrowdownh.gif" /></asp:LinkButton>
                                            </HeaderTemplate>
                                            <EditItemTemplate>
                                                <asp:TextBox ID="txtInnerName" runat="server" Text='<%# Eval("InnerName") %>' Width="99%"></asp:TextBox>
                                            </EditItemTemplate>
                                        </asp:TemplateField>
                                        ...
                                        <asp:TemplateField SortExpression="Added" HeaderText="<%$ Resources:Resource, Admin_AddDate %>">
                                            ...
                                            <HeaderTemplate>
                                                <asp:LinkButton ID="lbOrderAdded" runat="server" CommandName="Sort" CommandArgument="Added">
                                                    ...
                                                    <asp:Image ID="arrowAdded" CssClass="arrow" runat="server" ImageUrl="images/arrowdownh.gif" /></asp:LinkButton>
                                            </HeaderTemplate>
                                            <ItemTemplate>
                                        ...
                                        <asp:TemplateField SortExpression="Modified" HeaderText="<%$ Resources:Resource, Admin_ModifyDate %>">
                                            ...
                                            <HeaderTemplate>
                                                <asp:LinkButton ID="lbOrderModified" runat="server" CommandName="Sort" CommandArgument="Modified">
                                                    ...
                                                    <asp:Image ID="arrowModified" CssClass="arrow" runat="server" ImageUrl="images/arrowdownh.gif" /></asp:LinkButton>
                                            </HeaderTemplate>
                                            <EditItemTemplate>
                                        ...
                                        <asp:TemplateField HeaderStyle-Width="60px" ItemStyle-HorizontalAlign="Center">
                                            <EditItemTemplate>
                                                ...
                                                <asp:ImageButton ID="buttonDelete" runat="server" ImageUrl="images/deletebtn.png"
                                                    CssClass="deletebtn showtooltip" CommandName="DeleteBlock" CommandArgument='<%# Eval("ID")%>'
                                                ...
                                                <ajaxToolkit:ConfirmButtonExtender ID="ConfirmButtonExtender2" runat="server" TargetControlID="buttonDelete"
                                                    ConfirmText="<%$ Resources:Resource, Admin_StaticPage_Confirmation %>">
