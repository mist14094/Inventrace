...
namespace AdvantShop.Helpers
{
    public class CommonHelper
    {
        ...
        public static void SetCookie(string cookieName, string cookieValue, bool httpOnly = false, bool crossSubDomain = true)
        {
            SetCookie(cookieName, cookieValue, new TimeSpan(7, 0, 0, 0), httpOnly, crossSubDomain);
        }
        ...
        public static void SetCookie(string cookieName, string cookieValue, TimeSpan ts, bool httpOnly, bool crossSubDomains = true)
        {
            try
            {
                ...
                if (crossSubDomains && HttpContext.Current != null && !HttpContext.Current.Request.Url.ToString().Contains("localhost"))
        ...
        public static void SetCookieCollection(string cookieName, NameValueCollection cookieValue, TimeSpan ts)
        {
            try
            {
                ...
                if (HttpContext.Current != null && !HttpContext.Current.Request.Url.ToString().Contains("localhost"))
                {
