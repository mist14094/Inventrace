...
namespace AdvantShop.Orders
{
    public class GiftCertificateService
    {
        ...
        {
            SQLDataAccess.ExecuteScalar("DELETE FROM [Settings].[GiftCertificatePayments]", CommandType.Text);
        }
        ...
        public static List<int> GetCertificateTaxesId()
        {
            return SQLDataAccess.ExecuteReadColumn<int>(
                "SELECT * FROM [Settings].[GiftCertificateTaxes]",
                CommandType.Text, "TaxID");
        }
