...
namespace AdvantShop.Orders
{
    ...
    public static class ShoppingCartService
    {
        ...
        {
            item.ShoppingCartItemId = SQLDataAccess.ExecuteScalar<int>(@"INSERT INTO Catalog.ShoppingCart (ShoppingCartType, CustomerId, OfferId, AttributesXml, Amount, CreatedOn, UpdatedOn) 
        ...
        public static void DeleteShoppingCartItem(int itemId)
        {
            SQLDataAccess.ExecuteNonQuery
                ("DELETE FROM Catalog.ShoppingCart WHERE ShoppingCartItemId = @ShoppingCartItemId", CommandType.Text,
                    new SqlParameter { ParameterName = "@ShoppingCartItemId", Value = itemId }
                );
        }
