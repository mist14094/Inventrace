...
namespace AdvantShop.Orders
{
    public class ShoppingCart : List<ShoppingCartItem>
    {
        ...
        {
            get { return this.Sum(shpItem => shpItem.Price * shpItem.Amount); }
        }
                ...
                return
                    !this.Any(
                        ...
                        (!item.Offer.Product.Enabled ||
                         (item.Amount > item.Offer.Amount && SettingsOrderConfirmation.AmountLimitation &&
                          !item.Offer.CanOrderByRequest) || item.Amount < item.Offer.Product.MinAmount ||
