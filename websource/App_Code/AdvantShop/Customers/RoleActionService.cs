...
namespace AdvantShop.Customers
{
    public class RoleActionService
    {
        ...
        public static RoleAction GetCustomerRoleActionByKeyAndCustomerId(Guid customerId, string key)
        {
            return SQLDataAccess.ExecuteReadOne<RoleAction>("Select RoleActionKey, Enabled From Customers.CustomerRoleAction Where CustomerID = @CustomerID And RoleActionKey = @Key", CommandType.Text,
                                                                     GetCustomerRoleActionFromReader,
                                                                     new SqlParameter("@CustomerID", customerId),
