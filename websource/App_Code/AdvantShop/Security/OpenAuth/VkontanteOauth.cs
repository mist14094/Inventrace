...
namespace AdvantShop.Security.OpenAuth
{
    public class VkontakteOauth
    {
        ...
        public static void VkontakteAuth(string code, string email)
        {
            try
            {
                var request = WebRequest.Create(string.Format("https://oauth.vk.com/access_token?client_id={0}&client_secret={1}&code={2}&redirect_uri={3}",
                                                                ...
                                                                code,
                                                                StringHelper.MakeASCIIUrl(SettingsMain.SiteUrl) + "/Login.aspx?auth=vk"));
                request.Method = "GET";
            ...
            {
                Debug.LogError(ex + "   code:" + code + "   redirectUrl:" + StringHelper.MakeASCIIUrl(SettingsMain.SiteUrl) + "/Login.aspx?auth=vk");
            }
        }
        ...
        public static void VkontakteAuthDialog()
        {
