...
namespace AdvantShop.Payment
{
    public class LiqPay: PaymentMethod
    {
        ...
        {
            return string.Format(response, MerchantId, SuccessUrl, NotificationUrl, order.OrderID, order.Sum.ToString("F2").Replace(",", "."), MerchantISO, "Order " + order.OrderID, order.OrderCustomer.MobilePhone);
        }
