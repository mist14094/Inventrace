...
namespace AdvantShop.Payment
{
    public class Avangard : PaymentMethod
    {
        ...
        {
            string failNotification = "<span style=\"color:red;font-size:14px;\">ќплата не проведена: ќтказ банка Ц эмитента карты. ќшибка в процессе оплаты, указаны неверные данные карты.</span>";
            ...
            if (order != null)
            {
                ...
                return "<span style=\"color:green; font-size:14px; \">ќплата проведена</span>";
