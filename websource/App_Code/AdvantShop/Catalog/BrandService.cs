...
namespace AdvantShop.Catalog
{
    ...
    public class BrandService
    {
        ...
        public static bool IsExist(string brandName)
        {
            return SQLDataAccess.ExecuteScalar<int>("select Count(*) from Catalog.Brand where LOWER (BrandName)=@BrandName", CommandType.Text,
                                                    new SqlParameter { ParameterName = "@BrandName", Value = brandName.ToLower() }) > 0;
        }
