...
namespace AdvantShop.Catalog
{
    public class CouponService
    {
        ...
        */
        ...
        {
            return GetCustomerCoupon(CustomerSession.CustomerId);
        }
        ...
        {
            DeleteCustomerCoupon(couponId, CustomerSession.CustomerId);
        }
        ...
        {
            if (!IsCustomerHaveThisCupon(couponId, CustomerSession.CustomerId))
                AddCustomerCoupon(couponId, CustomerSession.CustomerId);
        }
