...
namespace AdvantShop
{
    ...
    public static class Strings
    {
        ...
        public static string FileNamePlusDate(this string fileName, DateTime date)
        {
            var temp = fileName.Split('.');
            if (temp.Length == 2)
            {
                return temp[0] + "_" + date.ToString("yyyyMMddHHmmss") + "." + temp[1];
            }
            return fileName;
        }

        public static string FileNamePlusDate(this string fileName)
        {
            return fileName.FileNamePlusDate(DateTime.Now);
        }
