...
namespace AdvantShop.Core.Caching
{
    ...
    {
        private const string ModuleSetPref = "ModuleSettings_";
        ...
        public static string GetModuleSettingsCacheObjectName(string strName)
        {
            return ModuleSetPref + strName;
        }

        public static string GetTemplateSettingsCacheObjectName(string strName)
        {
            return TemplateSetPref + strName;
        }
