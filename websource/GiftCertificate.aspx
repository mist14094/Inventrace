...
<asp:Content ID="Content1" ContentPlaceHolderID="cphMain" runat="Server">
    <script>
        $(function () { getPaymentButton('<%=OrderId%>', 'btnPaymentFunctionality'); });    
    </script>
    <div class="stroke">
        <div class="content-owner">
            <h1>
                <% = Resource.Client_GiftCertificate_Header %></h1>
            <asp:MultiView runat="server" ID="mvGiftCertificate" ActiveViewIndex="0">
                <asp:View ID="vMainGiftCertificateView" runat="server">
                    <div class="form-c">
                            ...
                            <li>
                                ...
                                <div class="param-value">
                                    <adv:Button ID="btnBuyGiftCertificate" Type="Submit" Size="Middle" runat="server"
                                        Text="<%$ Resources:Resource, Client_GiftCertificate_Buy %>" OnClick="btnBuyGiftCertificate_Click">
                                    </adv:Button>
                ...
                <asp:View ID="vFinalGiftCertificateView" runat="server">
                    <div style="text-align: center;">
                        ...
                        <br />
                        <br />
                        <asp:Label ID="Label1" runat="server" Text="<%$ Resources:Resource, Client_OrderConfirmation_ManagerhvGotOrder %>"></asp:Label>
                        <br />
                        <br />
                        <asp:Label ID="Label2" runat="server" Text="<%$ Resources:Resource, Client_OrderConfirmation_MailSent %>"></asp:Label>
                        <br />
                        <br />
                        <br />
